    ...
    <div>
      ...
      <div className="mt-4">
        <div className="flex space-x-2 mb-3">
            <p className="rounded-full bg-transparent border border-steel flex justify-center items-center px-4 py-1 text-victoria text-body-4 2xl:text-3xl">{year}</p>
            <p className="rounded-full bg-transparent border border-steel flex justify-center items-center px-4 py-1 text-victoria text-body-4 2xl:text-3xl">{tools}</p>
        </div>
